...
<section>
  <form action="index.php?page=mnt_score" method="post">
    ...
    <fieldset>
      ...
      <input {{if readonly}}readonly{{endif readonly}} type="text" id="scoregenre" name="scoregenre" placeholder="Genero" value="{{scoregenre}}" />
      {{if error_scoregenre}}
     ...
     <fieldset>
      ...
      <input {{if readonly}}readonly{{endif readonly}} type="number" id="scoreyear" name="scoreyear" placeholder="Año" value="{{scoreyear}}" />
      {{if error_scoreyear}}
     ...
     <fieldset>
      ...
      <input {{if readonly}}readonly{{endif readonly}} type="number" id="scoresales" name="scoresales" placeholder="Ventas" value="{{scoresales}}" />
      {{if error_scoresales}}
     ...
     <fieldset>
      <label for="scoredocurl">Documento</label>
      <input {{if readonly}}readonly{{endif readonly}} type="text" id="scoredocurl" name="scoredocurl" placeholder="Url documento" value="{{scoredocurl}}" />
